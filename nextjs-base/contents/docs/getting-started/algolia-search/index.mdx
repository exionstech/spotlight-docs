...
[Algolia DocSearch](https://docsearch.algolia.com/) provides a fast, relevant search experience for documentation sites. It powers the search in this project (**Spotlight Docs**). Follow this guide to integrate it into your documentation.
